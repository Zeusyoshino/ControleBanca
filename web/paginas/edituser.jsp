                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-12">
                                <form data-toggle="validator" role="form" name="EditaUsuario" action="Executa" method="POST">
                                    <c:forEach var="user" items="${usu}">
                                        <div class="form-group">
                                            <label>Nome</label>
                                            <input class="form-control" name="nome" value="${user.nome}"  maxlength="100" required>
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" id="inputEmail" class="form-control" name="email" value="${user.email}" maxlength="50" required >
                                            <div class="help-block with-errors"></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Confirme seu Email</label>
                                            <input type="email" class="form-control" id="texto" name="confemail" value="${user.email}" maxlength="50" data-match="#inputEmail" data-match-error="Os emails não estão iguais." required>
                                            <div class="help-block with-errors"></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Senha</label>
                                            <input type="password" class="form-control" id="inputPassword" name="senha" value="${user.senha}" data-minlength="8" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="inputConfirm" name="confsenha" value="${user.senha}" data-match="#inputPassword" data-match-error="Atenção! As senhas não estão iguais." required>
                                            <span class="help-block">Mínimo de oito (8) dígitos</span>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Celular</label>
                                            <input type="tel" class="form-control" id="telefone" name="celular" value="${user.celular}" maxlength="15" required>
                                            <div class="help-block with-errors"></div>
                                        </div>                                                         
